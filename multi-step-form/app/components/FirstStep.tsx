...
const FirstStep = () => {
  return (
    <div className="w-full h-full relative bg-gray-200 lg:flex lg:flex-col lg:justify-between items-center">
      ...
      <div className="w-full h-24 absolute bg-white bottom-0 flex justify-end items-center lg:static">
        <div className="w-[90%]  flex justify-end items-center mx-auto lg:w-full">
          <button className="bg-blue-950 text-white text-xl px-6 py-2 rounded-md lg:text-base">
            Next Step
          </button>
        </div>
      </div>

    ...
    <div className='h-56 w-full steps-navigation lg:h-full lg:w-[40%] lg:rounded-xl lg:pl-10'>
      <div className='w-full flex justify-center items-start gap-10 py-10 lg:flex-col'>
        <div className='flex justify-center items-center gap-5'>
            <button className='w-10 h-10 rounded-full bg-transparent border-[1px] border-white text-white font-bold'>1</button>
        ...
        <div className='flex justify-center items-center gap-5'>
            <button className='w-10 h-10 rounded-full bg-transparent border-[1px] border-white text-white font-bold'>2</button>
        ...
        <div className='flex justify-center items-center gap-5'>
            <button className='w-10 h-10 rounded-full bg-transparent border-[1px] border-white text-white font-bold'>3</button>
        ...
        <div className='flex justify-center items-center gap-5'>
            <button className='w-10 h-10 rounded-full bg-transparent border-[1px] border-white text-white font-bold'>4</button>
